...
def evaluate(predict_file, output_csv_file, mode, label_file):
...
#         test_case = cipher_suite.decrypt(test_case.encode()).decode()
        ...
        gt_boxes = [float(num) for num in ss[1:]]
    ...
    for i in range(10):
        ...
        for j in range(len(all_class_precision)):
